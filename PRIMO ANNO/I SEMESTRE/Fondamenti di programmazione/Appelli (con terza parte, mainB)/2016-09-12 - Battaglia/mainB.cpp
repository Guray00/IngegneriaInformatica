...
int main(){
  ...
  Battaglia b4(3, 2);
  b4.aggiungi(0, 0, 4, 4, 1); // deve fallire
  b4.aggiungi(1, 1, 2, 2, 1); // successo
  b4.aggiungi(1, 1, 1, 1, 5); // deve fallire per via del giocatore
  cout << b4 << endl;

  Battaglia b5(3, 2);
  b5.aggiungi(0, 0, 1, 0, 1);
  b5.aggiungi(0, 1, 1, 1, 2);
  cout << b5 << endl;
