...
int main() {
    ...
    // TERZA PARTE
    const Polinomio P4(3, vett2);  // P4(x) = +2x^3 -3x^2 +5x -1
    cout<<bool(P4); // deve stampare zero

    const int vett5[] = {+2, 0, 0, 1};
    const Polinomio P5(3, vett5);
    cout<<bool(P5); // deve stampare 1

    const int vett6[] = {-1, 0, -2, -3};
    const Polinomio P6(3, vett6);
    cout<<bool(P6); // deve stampare 1
