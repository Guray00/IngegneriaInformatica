<?php
    // il parametro 'Codice' deve essere settato
    ...
    <body>
        ...
        <main>
            <div id='torneocreato'>
                ...
                <p>
                    Dai questo codice ai tuoi giocatori: gli servirà per iscriversi.
                </p>
                <a href="index.php" id='backhome'>
                Torna alla home
            </a>
            </div>
