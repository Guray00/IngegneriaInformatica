...
<body>
    ...
    <main>
        ...
        if (isset($_SESSION['login']) && $_SESSION['login'] === true) { ?>
            <script>
                ...
                function loadGames(ajaxGames) {
                    console.log(ajaxGames);

                    if (ajaxGames.length == 0) {
                        console.log("there is no game saved");
                        let p = document.createElement('p');
                        p.textContent = 'There is no game saved :(';
                        main.appendChild(p);
                    } else {
                ...
                function openGamePage(go) {
                    ...
                    sessionStorage.setItem("gameid", go.id);
        ...
        <?php
            ...
            echo "<h2>Please login to see your games</h2>";
            echo "<script>alert('Please login to see your games')</script>";
        }
        ?>
    </main>
